/**************************************************************************//**
 * @file     startup_mm32_mm0n1.s
 * @brief    CMSIS-Core(M) Device Startup File for MM32F031x8, xB/MM32L0xx
 * @version  V2.0.0
 * @date     20. May 2019
 ******************************************************************************/
/*
...
__Vectors:
    ...
    .long	Reserved10_Handler;                    ///<   2 Reserved
    .long	FLASH_IRQHandler;                      ///<   3 FLASH
    .long	RCC_CRS_IRQHandler;                    ///<   4 RCC & CRS
    ...
    .long	Reserved11_Handler;                    ///<   8 Reserved
    ...
    .long	ADC1_COMP_IRQHandler;                  ///<  12 ADC1 & COMP
    ...
    .long	Reserved12_Handler;                    ///<  17 Reserved
    .long	Reserved13_Handler;                    ///<  18 Reserved
    .long	TIM14_IRQHandler;                      ///<  19 TIM14
    .long	Reserved14_Handler;                    ///<  20 Reserved
    .long	TIM16_IRQHandler;                      ///<  21 TIM16
    .long	TIM17_IRQHandler;                      ///<  22 TIM17
    .long	I2C1_IRQHandler;                       ///<  23 I2C1
    .long	Reserved15_Handler;                    ///<  24 Reserved
    ...
    .long	CAN_IRQHandler;                        ///<  30 CAN
    .long	USB_IRQHandler;                        ///<  31 USB

//  .space   ( (224-32) * 4)                          /* Interrupts 32 .. 224 are left out */
__Vectors_End:
