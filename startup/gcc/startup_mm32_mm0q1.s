/**************************************************************************//**
 * @file     startup_mm32_mm0q1.s
 * @brief    CMSIS-Core(M) Device Startup File for MM32F003 / MM32F031x4,x6
 * @version  V2.0.0
 * @date     20. May 2019
 ******************************************************************************/
/*
...
__Vectors:
    ...
    .long	PWM_IRQHandler;                        ///<   2 RTC through EXTI Line & Tamper
    .long	FLASH_IRQHandler;                      ///<   3 FLASH
    .long	RCC_IRQHandler;                        ///<   4 RCC & CRS
    ...
    .long	HWDIV_IRQHandler;                      ///<   8 Reserved
    ...
    .long	ADC_COMP_IRQHandler;                   ///<  12 ADC1 & COMP
